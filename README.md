...
- **Baseline**  
  ...
  - Local: pasta `baseline/`.

- **Avançado**  
  Versão expandida do projeto, estruturada como um pipeline completo de Data Science.  
  - Etapas: tratamento de valores ausentes, engenharia de features, comparação de algoritmos, métricas avançadas e interpretabilidade.  
  - Implantação: aplicação interativa em Streamlit.  
